...
(function (global, factory) {
  ...
  var editor = renderer.create('<div class="note-editor note-frame card gradient-dark-grey"/>');
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-dark btn-sm" role="button" tabindex="-1">', function ($node, options) {
              ...
              children: [
                  ...
                  this.ui.dropdown({
                      items: (backColor ? [
                          ...
                          '  <div>',
                          '    <button type="button" class="note-color-reset btn btn-dark" data-event="backColor" data-value="inherit">',
                          ...
                          (foreColor ? [
                              ...
                              '  <div>',
                              '    <button type="button" class="note-color-reset btn btn-dark" data-event="removeFormat" data-value="foreColor">',
