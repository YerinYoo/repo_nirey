			...
			<div class="main-container">
				...
				<div class="page-header">
					...
					<ol class="breadcrumb d-md-flex d-none">
						...
						<li class="breadcrumb-item breadcrumb-active" aria-current="page">Carousels</li>
					</ol>
					<!-- Breadcrumb end -->
										...
										<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img src="assets/images/food/img2.jpg" class="d-block w-100" alt="Arise Admin Template">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img3.jpg" class="d-block w-100" alt="Arise Admin Template">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img4.jpg" class="d-block w-100" alt="Arise Admin Template">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card">
									<div class="card-body">
										<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img src="assets/images/food/img4.jpg" class="d-block w-100" alt="Vico Admin Carousel">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img5.jpg" class="d-block w-100" alt="Vico Admin Carousel">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img6.jpg" class="d-block w-100" alt="Vico Admin Carousel">
												</div>
											</div>
								...
								<div class="card">
									<div class="card-body">
										<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
											...
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img src="assets/images/food/img8.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img2.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img9.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												</div>
											</div>
								...
								<div class="card">
									<div class="card-body">
										<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
											...
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img src="assets/images/food/img5.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												...
												<div class="carousel-item">
													<img src="assets/images/food/img1.jpg" class="d-block w-100" alt="Best Admin Dashboards">
													<div class="carousel-caption d-none d-md-block">
								...
								<div class="card">
									<div class="card-body">
										<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img src="assets/images/food/img3.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												</div>
												<div class="carousel-item">
													<img src="assets/images/food/img9.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												</div>
										...
										<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
											<div class="carousel-inner">
												<div class="carousel-item active" data-bs-interval="10000">
													<img src="assets/images/food/img7.jpg" class="d-block w-100" alt="Best Admin Dashboards">
												</div>
