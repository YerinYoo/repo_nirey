...
<html lang="en">
	...
	<body>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="maps.html" class="current-page">Maps</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="main-container">
				...
				<div class="page-header">
					...
					<ol class="breadcrumb d-md-flex d-none">
						...
						<li class="breadcrumb-item breadcrumb-active" aria-current="page">Maps</li>
					</ol>
					<!-- Breadcrumb end -->
		...
		************* -->
		...
		<script src="assets/vendor/jvectormap/de-merc.js"></script>
		...
		<script src="assets/vendor/jvectormap/custom/resions-with-labels.js"></script>
		<script src="assets/vendor/jvectormap/custom/regions-selection.js"></script>
