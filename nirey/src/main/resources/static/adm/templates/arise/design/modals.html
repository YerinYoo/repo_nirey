							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="modals.html" class="current-page">Modals</a>
										</li>
										<li>
			...
			<div class="main-container">
				...
				<div class="page-header">
					...
					<ol class="breadcrumb d-md-flex d-none">
						...
						<li class="breadcrumb-item breadcrumb-active" aria-current="page">Modals</li>
					</ol>
					<!-- Breadcrumb end -->
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="modalDarkLabel">Modal title</h5>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>This is some placeholder content to show the scrolling behavior for modals. We use repeated line
										...
										When content becomes longer than the prefedined max-height of modal, content will be cropped and
