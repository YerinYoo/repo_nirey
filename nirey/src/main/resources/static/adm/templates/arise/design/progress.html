							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="progress.html" class="current-page">Progress Bars</a>
										</li>
										<li>
			...
			<div class="main-container">
				...
				<div class="page-header">
					...
					<ol class="breadcrumb d-md-flex d-none">
						...
						<li class="breadcrumb-item breadcrumb-active" aria-current="page">Progress</li>
					</ol>
					<!-- Breadcrumb end -->
						...
						<div class="row">
							...
							<div class="col-xxl-12">
								<div class="card">
									<div class="card-body">
										<div class="progress">
											<div class="progress-bar shade-green" role="progressbar" style="width: 25%" aria-valuenow="25"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="m-3"></div>
										<div class="progress">
											<div class="progress-bar shade-blue" role="progressbar" style="width: 50%" aria-valuenow="50"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="m-3"></div>
										<div class="progress">
											<div class="progress-bar shade-yellow" role="progressbar" style="width: 75%" aria-valuenow="75"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="m-3"></div>
										<div class="progress">
											<div class="progress-bar shade-red" role="progressbar" style="width: 100%" aria-valuenow="100"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="m-3"></div>
										<div class="progress">
											<div class="progress-bar shade-dark" role="progressbar" style="width: 100%" aria-valuenow="100"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="m-3"></div>
										<div class="progress">
											<div class="progress-bar shade-light" role="progressbar" style="width: 100%" aria-valuenow="100"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
									</div>
								</div>
							...
							<div class="col-xxl-12">
								<div class="card">
									<div class="card-body">
										<div class="progress">
											<div class="progress-bar shade-blue" role="progressbar" style="width: 20%" aria-valuenow="20"
												aria-valuemin="0" aria-valuemax="100"></div>
											<div class="progress-bar shade-green" role="progressbar" style="width: 20%" aria-valuenow="20"
												aria-valuemin="0" aria-valuemax="100"></div>
											<div class="progress-bar shade-yellow" role="progressbar" style="width: 20%" aria-valuenow="20"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
									</div>
								</div>
